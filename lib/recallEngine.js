 ...
 */
async function buildEmmaPrompt(db, userId, currentMessage) {
  ...
  const toneGuidance = generateToneGuidance(emotionContext);
 ...
 */
function generateToneGuidance(emotionContext) {
  if (!emotionContext) {
