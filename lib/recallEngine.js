 ...
 */
async function buildEmmaPrompt(db, userId, user, currentMessage, lang = 'en', sessionId = null) {
  ...
  console.log(`[recallEngine] buildEmmaPrompt done — totalPromptLen=${fullPrompt.length} hasAnalysisRequest=${fullPrompt.includes('emma_analysis')}`);
