 ...
 *
 * 2026-04-24: maxOutputTokens now 12288 — supports 30-minute interviews
 *             (Korean ~6000 chars, English ~10000+ chars).
 */
      ...
      `https://generativelanguage.googleapis.com/v1beta/models/${GEMINI_MODEL}:generateContent?key=${apiKey}`,
      {
        ...
        body: JSON.stringify({
          ...
          generationConfig: {
            ...
            temperature: 0.3,
            // 2026-04-24: raised from 8192 to 12288 per Tim's decision.
            // Target: Korean up to ~6000 chars content (≈12000 tokens at 2 tok/char).
            // English can go even longer since English ≈ 1 token per ~4 chars.
            // Covers 30-minute story-mode interviews comfortably.
...
function buildFragmentPrompt({ elements, conversationText, userMessagesText, lang, conversationMode = 'auto', topicAnchor = null }) {
  const el = elements;
...
${interviewHeader}${topicAnchorBlock}════════════════════════════════════════════════
