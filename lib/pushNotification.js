 ...
 *  - push_subscriptions table has no enum columns (all TEXT/INTEGER).
 *  - memory_nodes.node_type queries use VARCHAR comparison.
 *  - notification.type field is an internal string, not a DB enum.
